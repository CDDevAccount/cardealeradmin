    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-default" href="/index.php?r=dealer">Dealers &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                <h2>Towns</h2>
                ...
                <p><a class="btn btn-default" href="/index.php?r=town">Towns &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                <h2>Vehicles</h2>
                ...
                <p><a class="btn btn-default" href="/index.php?r=vehicle">Cars &raquo;</a></p>
            </div>
        </div>

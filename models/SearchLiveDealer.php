...
class SearchLiveDealer extends TblDealer
{
    ...
    public function rules()
    {
        return [
            [['id', 'pid'], 'integer'],
            [['name', 'branchname','vehicle_count', 'address1', 'address2', 'address3', 'city', 'postcode', 'phone', 'mobile', 'contact_name', 'contact_title', 'dealer_web', 'dealer_email', 'outcode','longitude','latitude','verified', 'fb_onboard','dd_customer','updated_at', 'created_at'], 'safe'],
        ];
    }
	...
	$query->andFilterWhere(['has_stock'=>1]);
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'email_good', $this->email_good])
            ...
            ->andFilterWhere(['>', 'vehicle_count', $this->vehicle_count])
             ...
             ->andFilterWhere(['like', 'fb_onboard', $this->fb_onboard])
             ->andFilterWhere(['like', 'dd_customer', $this->dd_customer])
